...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
  ...
  /*  public PlacesAutoCompleteAdapter (MyCallBack callBack){
...
//                .setCountry("JM")
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View convertView = layoutInflater.inflate(R.layout.set_address_row, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull PredictionHolder mPredictionHolder, final int i) {
        ...
        mPredictionHolder.area.setText(mResultList.get(i).address);
//        mPredictionHolder.area.setText(mResultList.get(i).area);
      /*  mPredictionHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                place_search.setText(mResultList.get(i).address);
            }
        });*/
    }
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        PredictionHolder(View itemView) {
            super(itemView);
            area = itemView.findViewById(R.id.ctvArea);
            address = itemView.findViewById(R.id.ctvAddress);
            mRow = itemView.findViewById(R.id.rlRow);
