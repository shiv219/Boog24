...
public class GetMyBookingsPresenter extends BasePresenter<IMyBookingsView> {

    public void userSignin(final Activity activity,String type) {
        getView().enableLoadingBar(activity, true, activity.getResources().getString(R.string.loading));
        MyApplication.getInstance()
                .getApiService()
                .myBookings(Constants.ACCESS_TOKEN, Prefs.getString(Constants.SharedPreferences_loginKey,""),Prefs.getString(Constants.SharedPreferences_Langauge,""),type)
