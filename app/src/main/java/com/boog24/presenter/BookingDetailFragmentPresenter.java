...
public class BookingDetailFragmentPresenter extends BasePresenter<IBookingView> {

    public void getBooking(final Activity activity,String orderid) {
        getView().enableLoadingBar(activity, true, activity.getResources().getString(R.string.loading));
        MyApplication.getInstance()
                .getApiService()
                .gatBookingDetails(Constants.ACCESS_TOKEN, Prefs.getString(Constants.SharedPreferences_loginKey,""),Prefs.getString(Constants.SharedPreferences_Langauge,""),orderid)
