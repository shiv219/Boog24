...
public class GetNotificationListPresenter extends BasePresenter<IGetNotificationListView> {
    ...
    public void getNotifications(final Activity activity) {
        ...
        MyApplication.getInstance()
                .getApiService()
                .getNotificationList(Constants.ACCESS_TOKEN, Prefs.getString(Constants.SharedPreferences_loginKey,""),Prefs.getString(Constants.SharedPreferences_Langauge,""))
